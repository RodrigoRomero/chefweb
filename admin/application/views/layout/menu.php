<div id="sidebar-left" class="span2">
	<div class="nav-collapse sidebar-nav">
		...
		<ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="<?php echo base_url('module/load/m/productos/a/listado')?>"><i class="icon-usd"></i><span class="hidden-tablet"> Productos</span></a></li>
            <li><a href="<?php echo base_url('module/load/m/orders/a/listado')?>"><i class="icon-usd"></i><span class="hidden-tablet"> Ordenes</span></a></li>
            <li><a href="<?php echo base_url('module/load/m/customers/a/listado')?>"><i class="icon-user"></i><span class="hidden-tablet"> Clientes</span></a></li>
    		...
    		<li><a class="submenu" href="<?php echo base_url('module/load/m/configuraciones/a/listado')?>"><i class="icon-cog"></i><span> Configuraciones</span></a></li>
